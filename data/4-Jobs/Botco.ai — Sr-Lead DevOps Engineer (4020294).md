---
note_type: Job
name: Sr/Lead DevOps Engineer
company: Botco.ai
source: Wellfound
source_id: "4020294"
url: https://wellfound.com/jobs/4020294-sr-lead-devops-engineer
company_url: https://wellfound.com/company/botco-ai-1
compensation: $60k – $84k
equity: 
job_type: contract
remote: true
locations: Mountain View
remote_locations: North America, South America
experience_min: 5
...
fit_overall_match: 0.83
fit_primary_stack: AWS, Kubernetes, Docker, GitHub Actions
fit_missing_skills: Kubernetes, Azure
fit_have_skills: AWS, Docker, GitHub Actions, Infrastructure-as-code, Git, Linux basics, CI/CD concepts, Grafana, Sentry, Python, Bash, PostgreSQL, On-call readiness, Process-minded approach, Communication, Startup experience
fit_familiar_skills: Claude Code
fit_dont_have_skills: Kubernetes, Azure
fit_summary: "You have strong ownership appeal here: sole DevOps engineer on a startup team with high autonomy and direct impact. Your AWS, Docker, CI/CD, and infrastructure-as-code expertise align well. The critical gap is Kubernetes—a hard requirement you've never used—and Azure, which the role also touches. Your 25+ years of experience, startup background, and proven incident-response capability are your strongest selling points; lead with your production incident story and your track record scaling infrastructure under resource constraints."
...
To be considered, make sure to include in your application:
* your linkedin profile
* a link to a 2–3 minute video walking us through the last production incident you led. What broke, what you did, and who you told.
